...
public class WordCount {
    ...
    public static class TokenizerMapper
        ...
        public void map(Object key, Text value, Context context) 
            ...
            //Setting key as Conference Name
            word.set(values[0]);
            //Setting Value as Conference City
            conf.set(values[3]);
  ...
  public static class ListSumReducer
      ...
      public void reduce(Text key, Iterable<Text> values,Context context)
            throws IOException, InterruptedException {
          //final string of all the city names for a particular conference
          String textValues = "";
          for (Text val : values) {
            //To avoid repetation of same city for the same conference
